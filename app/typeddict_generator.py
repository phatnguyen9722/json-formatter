...
def generate_typeddict_class(
    class_name: str, data: Dict[str, Any], indent: int = 0
) -> Tuple[str, List[str]]:
    """
...
def json_to_typeddict(data: Any, root_class_name: str = "RootObject") -> str:
    """
...
def generate_from_json_string(json_str: str, class_name: str = "RootObject") -> str:
    """
